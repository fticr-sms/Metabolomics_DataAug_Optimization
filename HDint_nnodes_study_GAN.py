...
for crit_n_str in test_nodes:
    ...
    generator.save_weights('gan_models/PCDint_gen_opt_gen_'+ gen_nodes_str + 'crit_' + crit_n_str)
    ...
    with open('gan_models/PCDint_results_opt_gen_'+ gen_nodes_str + 'crit_' + crit_n_str + '.pickle', 'wb') as handle:
