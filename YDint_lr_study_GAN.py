...
training_montage(data_treated, lbls, data_treated, lbls, n_epochs, generator, critic, generator_optimizer, critic_optimizer,
                     input_realdata_dist, batch_size, grad_pen_weight=5, k_cov_den=20, k_crossLID=15)

# Save the generator model's weights.
generator.save_weights('gan_models/YDint_gen_opt_lr_'+ lr_str)
...
with open('gan_models/YDint_results_opt_lr_' + lr_str + '.pickle', 'wb') as handle:
